...
TotalNeuterRate <-sum(VectorMatrix[,c(24,26,28)])/((sum(VectorMatrix[,22])*0.794)+sum(VectorMatrix[,c(23,25,27)])+sum(VectorMatrix[,c(24,26,28)]))#juveniles,adults and elderly
AdultNeuterRate<-sum(VectorMatrix[,c(26,28)])/(sum(VectorMatrix[,c(25,27)])+sum(VectorMatrix[,c(26,28)]))#96% adult neuter rate
JuvenileNeuterRate<-sum(VectorMatrix[,c(24)])/(sum(VectorMatrix[,c(23)])+sum(VectorMatrix[,c(24)]))#66% juvenile neuter rate
...
TotalN10<-sum(VectorMatrix[120,c(24,26,28)])/((sum(VectorMatrix[120,22])*0.794)+sum(VectorMatrix[120,c(23,25,27)])+sum(VectorMatrix[120,c(24,26,28)]))#juveniles,adults and elderly
AdultN10<-sum(VectorMatrix[120,c(26,28)])/(sum(VectorMatrix[120,c(25,27)])+sum(VectorMatrix[120,c(26,28)]))#96% adult neuter rate
JuvenileN10<-sum(VectorMatrix[120,c(24)])/(sum(VectorMatrix[120,c(23)])+sum(VectorMatrix[120,c(24)]))#66% juvenile neuter rate
TotalN10
AdultN10
JuvenileN10
...
#stray 8 to 14
plot(VectorMatrix[,8])#kitten
lines(VectorMatrix[,8])#kitten
plot(VectorMatrix[,9])#Unneutered juvenile
lines(VectorMatrix[,9])#Unneutered juvenile
plot(VectorMatrix[,10])#neutered juvenile
lines(VectorMatrix[,10])#neutered juvenile
plot(VectorMatrix[,11])#unneutered adult
lines(VectorMatrix[,11])#unneutered adult
plot(VectorMatrix[,12])#neutered adult
lines(VectorMatrix[,12])#neutered adult
plot(VectorMatrix[,13])#unneutered elderly
lines(VectorMatrix[,13])#unneutered elderly
plot(VectorMatrix[,14])#neutered elderly
lines(VectorMatrix[,14])#neutered elderly

plot(c(1:120),Feral_A[1:120])
lines(c(1:120),Feral_A[1:120])

plot(c(1:120),Shelter_A[1:120])
lines(c(1:120),Shelter_A[1:120])

plot(c(1:120),Owned_A[1:120])
lines(c(1:120),Owned_A[1:120])

plot(c(1:120),Stray_A[1:120])
lines(c(1:120),Stray_A[1:120])
...
TotalNeuterRate_LN <-sum(VectorMatrix[,c(24,26,28)])/((sum(VectorMatrix[,22])*0.794)+sum(VectorMatrix[,c(23,25,27)])+sum(VectorMatrix[,c(24,26,28)]))#juveniles,adults and elderly
AdultNeuterRate_LN<-sum(VectorMatrix[,c(26,28)])/(sum(VectorMatrix[,c(25,27)])+sum(VectorMatrix[,c(26,28)]))#96% adult neuter rate
JuvenileNeuterRate_LN<-sum(VectorMatrix[,c(24)])/(sum(VectorMatrix[,c(23)])+sum(VectorMatrix[,c(24)]))#66% juvenile neuter rate
...
TotalN10_LN<-sum(VectorMatrix[120,c(24,26,28)])/((sum(VectorMatrix[120,22])*0.794)+sum(VectorMatrix[120,c(23,25,27)])+sum(VectorMatrix[120,c(24,26,28)]))#juveniles,adults and elderly
AdultN10_LN<-sum(VectorMatrix[120,c(26,28)])/(sum(VectorMatrix[120,c(25,27)])+sum(VectorMatrix[120,c(26,28)]))#96% adult neuter rate
JuvenileN10_LN<-sum(VectorMatrix[120,c(24)])/(sum(VectorMatrix[120,c(23)])+sum(VectorMatrix[120,c(24)]))#66% juvenile neuter rate
TotalN10_LN
AdultN10_LN
JuvenileN10_LN
...
plot(c(1:120),Feral_LN[1:120])
lines(c(1:120),Feral_LN[1:120])

plot(c(1:120),Shelter_LN[1:120])
lines(c(1:120),Shelter_LN[1:120])

plot(c(1:120),Owned_LN[1:120])
lines(c(1:120),Owned_LN[1:120])

plot(c(1:120),Stray_LN[1:120])
lines(c(1:120),Stray_LN[1:120])
...
TotalN10_HN<-sum(VectorMatrix[120,c(24,26,28)])/((sum(VectorMatrix[120,22])*0.794)+sum(VectorMatrix[120,c(23,25,27)])+sum(VectorMatrix[120,c(24,26,28)]))#juveniles,adults and elderly
AdultN10_HN<-sum(VectorMatrix[120,c(26,28)])/(sum(VectorMatrix[120,c(25,27)])+sum(VectorMatrix[120,c(26,28)]))#96% adult neuter rate
JuvenileN10_HN<-sum(VectorMatrix[120,c(24)])/(sum(VectorMatrix[120,c(23)])+sum(VectorMatrix[120,c(24)]))#66% juvenile neuter rate
TotalN10_HN
AdultN10_HN
JuvenileN10_HN
...
plot(c(1:120),Feral_HN[1:120])
lines(c(1:120),Feral_HN[1:120])

plot(c(1:120),Shelter_HN[1:120])
lines(c(1:120),Shelter_HN[1:120])

plot(c(1:120),Owned_HN[1:120])
lines(c(1:120),Owned_HN[1:120])

plot(c(1:120),Stray_HN[1:120])
lines(c(1:120),Stray_HN[1:120])
...
data <- matrix(c(mean(Owned_LN[109:120]),mean(Stray_LN[109:120]),mean(Feral_LN[109:120]),mean(Shelter_LN[109:120]),
                 mean(Owned_A[109:120]),mean(Stray_A[109:120]),mean(Feral_A[109:120]),mean(Shelter_A[109:120]),
                 mean(Owned_HN[109:120]),mean(Stray_HN[109:120]),mean(Feral_HN[109:120]),mean(Shelter_HN[109:120])), 
               nrow=4,byrow=F)


data <- matrix(c(median(Owned_LN[109:120]),median(Stray_LN[109:120]),median(Feral_LN[109:120]),median(Shelter_LN[109:120]),
                 median(Owned_A[109:120]),median(Stray_A[109:120]),median(Feral_A[109:120]),median(Shelter_A[109:120]),
                 median(Owned_HN[109:120]),median(Stray_HN[109:120]),median(Feral_HN[109:120]),median(Shelter_HN[109:120])), 
               nrow=4,byrow=F)

colnames(data) <- c("90%","95%","98%")
rownames(data) <- c("owned","stray","feral","shelter")
barplot(data, col=coul , border="white", xlab="Percentage of owned adult cats neutered",ylab="numbers of cats",ylim=c(0,160000),cex.axis=1.2, cex.names=1.2,cex.lab=1.2)
legend("topright", legend = c("owned","stray","feral","shelter") , 
...
colSums(data)[3]/colSums(data)[2]
# Transform this data in %
data_percentage <- apply(data, 2, function(x){x*100/sum(x,na.rm=T)})


# Make a stacked barplot--> it will be in %!
barplot(data_percentage[2:4,], col=coul[2:4] , border="white", xlab="Proportion of owned adult cats neutered",ylab="percentage",cex.axis=1.2, cex.names=1.2,cex.lab=1.2)
legend("topright", legend = c("stray","feral","shelter") , 
