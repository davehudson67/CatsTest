...

{
  ...
  # Use blob_endpoint() instead of storage_endpoint()
  ...
  { 
    ...
    observe({
      if (input$useNationalAverages) {
        ...
        #updateSliderInput(session, "timeframe_pred", value = 5)  # Example: 5-year default
        updateRadioButtons(session, "owned_neut_rate_A", selected = "95%")  # Example: 95% default
        updateSliderInput(session, "owned_neut_rate_K", value = 41)  # Example: 40% default
...
'
    ...
    # Delete temporary blob storeage files
